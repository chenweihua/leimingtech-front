...
<@p.header title="${goods.goodsName}－LmShop"/>
...
<style type="text/css">
	...
	.ncg-com-list .content ul li .goods-name_new { 
		line-height:18px;
		height: 36px; 
		width: 90%;
    	overflow: hidden; 
	...
	.nc-meta dl dd, .nc-key dl dd, .nc-pay dl dd {
	    line-height: 30px;
	    display: inline;
	    width: 450px;
	    margin-left: 4px;
...
<article id="content">
	...
	<section class="nc-detail">
        ...
        <div class="nc-detail-bd"> 
			...
			<div class="preview">
				<div id="vertical" class="bigImg">
					<img src="${imgServer}${goods.goodsImage}_${imageSet.big_pic_width}x${imageSet.big_pic_height}.${(goods.goodsImage?split("."))[goods.goodsImage?split(".")?size-1]}" width="380" height="400" alt="" id="midimg" />
						...
						<ul>
			                ...
			                <#if goodsImgList??>
				                <#list goodsImgList as il>
										<li><img src="${imgServer}${il}_${imageSet.tiny_pic_width}x${imageSet.tiny_pic_height}.${(il?split("."))[il?split(".")?size-1]} " width="68" height="68" alt=""/></li>
								</#list>
							</#if>
						</ul>
					</div>
				...
				<div class="name">
	          	...
	          	<div class="nc-meta"> 
		            ...
		            <dl class="nc-detail-price ">
		              <dt>市&#12288;场&#12288;价：</dt>
		              <dd>
		              	<strong>&yen;<#if goods.goodsMarketPrice==''>${goods.goodsStorePrice}<#else>${goods.goodsMarketPrice}</#if><#if rate!=''>（&#36;${(goods.goodsMarketPrice/(rate?number))?string("0.##")}）</#if></strong>
		              </dd>
		            </dl>
		            <#if preferential!='' && preferential??>
		            <dl class="nc-detail-price " >
		              <dt>会&#12288;员&#12288;价：</dt>
		              <dd>
		              	<strong nctype="goods_price">&yen;${goods.goodsStorePrice * preferential /100 }<#if rate!=''>（&#36;${(goods.goodsStorePrice/(rate?number))?string("0.##")}）</#if></strong>
		              </dd>
		            </dl>
		            </#if>
		            
		            <#assign promoTag = newTag("promoteTag")/>
		            <#assign promo = promoTag("{'storeId':'${goods.storeId}'}")/>
				    <#if (promo!='')>
			            <dl class="nc-detail-price " >
			              <dt>促&#12288;&#12288;&#12288;销：</dt>
			              <dd>
			              	<em class="hl_red_bg">满减</em><span class="hl_red">${promo}</span>
			              </dd>
			            </dl>
		            </#if>
				  ...
				  <div class="ncs-goods-handle fl">
				    ...
				    <div class="handle-right" id="handle-r"><span></span>
				      <ul >
				        ...
				        <li><i class="share-store"></i><a href="javascript:void(0)" onclick="collect_store('-9','2','${goods.storeId}');" >收藏店铺<em nctype="store_collect"><#if storeinfo ??&& storeinfo!=null >${storeinfo.storeCollect}</#if></em></a></li>
				      </ul>
				    </div>
				  </div>
				   <div class="clear"></div>
		...
		<#else>
            ...
            <dt>商品已下架</dt>
            <dd>1.&nbsp;请联系卖家咨询</dd>
            <dd>2.&nbsp;逛逛<a href="${base}/store/shop?storeId=${goods.storeId}">商家店铺</a>选择其他商品 </dd>
          </dl>
		</#if>
			        ...
			        <div class="ncg-store-info">
	          		...
	          		<#if goods.storeId!=0>
		          		<div class="goto" id="shop-other"> 
		          			<a href="${base}/store/shop?storeId=${goods.storeId}" target="_blank">进入商家店铺</a>
		          		</div>
	          		</#if>
			        </div>
				</div>
				...
				<nav class="tabbar pngFix" id="main-nav">
					<div class="pr" style="z-index: 70;">
					  <ul id="categorymenu">
					    ...
					    <li <#if tab==0>class="current"</#if>><a name="table" toAction="goodsBody" toTable="#table1" href="javascript:void(0);" ><span>商品详情</span></a></li>
					    <li <#if tab==2>class="current"</#if>><a name="table" toAction="evaluateGoods" toTable="#table2" href="javascript:void(0);"><span>商品评论</span></a></li>
					    <li <#if tab==1>class="current"</#if>><a name="table" toAction="saleRecord" toTable="#table3" href="javascript:void(0);"><span>销售记录</span></a></li>
						<#if isShow?? && isShow!='null' && isShow==1>
					    	<li><a name="table" toAction="consult" toTable="#table4" href="javascript:void(0);"><span>产品咨询</span></a></li>
	            		</#if>
					  </ul>
...
function init(){
	...
	var url = "";
	if(tab==0){
		url = '${base}/product/goodsBody';
	}
	if(tab==1){
		url = '${base}/product/saleRecord';		
	}
	if(tab==2){
		url = '${base}/product/evaluateGoods';
	}
